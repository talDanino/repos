...
namespace project_3
{
    static class dbAdapter
    {
        ...
        {
            string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Danino\source\repos\project_3\project_3\SearchDb.mdf;Integrated Security=True";
