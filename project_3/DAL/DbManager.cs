...
namespace DAL
{
    public static class DbManager
    {
        ...
        {
            string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Danino\source\repos\project_3\DAL\SearchDbNew.mdf;Integrated Security=True";
        ...
        {
            string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Danino\source\repos\project_3\SearchDbNew.mdf;Integrated Security=True;user instance=false";
            SqlConnection sql = null;
